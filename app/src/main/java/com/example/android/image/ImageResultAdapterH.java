...
public class ImageResultAdapterH extends RecyclerView.Adapter<ImageResultAdapterH.ResultViewHolder> {
    private Context mContext;
    private ArrayList<ImageResult> mImageResult;


    public ImageResultAdapterH(Context context, ArrayList<ImageResult> imageResult){
        mContext=context;
    ...
    public ResultViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.result_hitem,parent,false);
